...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final favorite = favoriteState.contains(product);
    final cartState = ref.watch(cartProviderNotifier);
    final cartCount = cartState.getQuantity(product.id);
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    Column(
                      children: [buildProductCartCounter(product, cartCount)],
                    ),
                    const SizedBox(height: 20),
                    Expanded(
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            cartCount == 0 ? 'Add to Cart' : 'In Basket',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                            ),
