  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `todos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` TEXT NOT NULL, `status` TEXT NOT NULL, `priority` TEXT NOT NULL, `date` TEXT NOT NULL, `time` TEXT NOT NULL, `pid` INTEGER NOT NULL, FOREIGN KEY (`pid`) REFERENCES `projects` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION)');
...
class _$ProjectDao extends ProjectDao {
  ...
  @override
  Future<Project?> findProjectById(int pid) async {
...
class _$TodoDao extends TodoDao {
  ...
  @override
  Future<Todo?> findTodoById(int tid) async {
